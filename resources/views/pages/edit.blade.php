<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Edit Data Siswa:') }} {{ $data->fullname }}
        </h2>
    </x-slot>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="mb-4">
                                ...
                                <input type="text" name="fullname" id="fullname"
                                    ...
                                    value="{{ $data->fullname ? $data->fullname : old('fullname') }}">
                                @error('fullname')
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="placeofbirth" id="placeofbirth"
                                    ...
                                    value="{{ $data->placeofbirth ? $data->placeofbirth : old('placeofbirth') }}"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" name="dateofbirth" id="dateofbirth"
                                    ...
                                    value="{{ $data->dateofbirth ? $data->dateofbirth : old('dateofbirth') }}">
                                @error('dateofbirth')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="mb-4">
                                ...
                                <input type="text" name="religion" id="religion"
                                    ...
                                    value="{{ $data->religion ? $data->religion : old('religion') }}"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="education" id="education"
                                    ...
                                    value="{{ $data->education ? $data->education : old('education') }}"
                                    placeholder="Contoh: SLTP">
                                @error('education')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="work" id="work"
                                    ...
                                    value="{{ $data->work ? $data->work : old('work') }}">
                                @error('work')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="mb-4">
                                ...
                                <input type="text" name="maritalstatus" id="maritalstatus"
                                    ...
                                    value="{{ $data->maritalstatus ? $data->maritalstatus : old('maritalstatus') }}">
                                @error('maritalstatus')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="mb-4">
                                ...
                                <input type="number" name="nik" id="nik"
                                    ...
                                    value="{{ $data->nik ? $data->nik : old('nik') }}" placeholder="350xxxxxxxxxxxxx">
                                @error('nik')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="mb-4">
                                ...
                                <input type="date" name="earlyentry" id="earlyentry"
                                    ...
                                    value="{{ $data->earlyentry ? $data->earlyentry : old('earlyentry') }}">
                                @error('earlyentry')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="nomail" id="nomail"
                                    ...
                                    value="{{ $data->nomail ? $data->nomail : old('nomail') }}"
                                    placeholder="Contoh: 017/Peng.PPg/YRJS/TA/A/VI/2021">
                                @error('nomail')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="mb-4">
                                ...
                                <input type="date" name="datemail" id="datemail"
                                    ...
                                    value="{{ $data->datemail ? $data->datemail : old('datemail') }}">
                                @error('datemail')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="mb-4">
                                ...
                                <input type="text" name="citizenship" id="citizenship"
                                    ...
                                    value="{{ $data->citizenship ? $data->citizenship : old('citizenship') }}"
